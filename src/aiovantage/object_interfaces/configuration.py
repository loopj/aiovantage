...
class ConfigurationInterface(Interface):
    ...
    @method("Configuration.DeleteObject")
    ...
    @method("Configuration.CreateObject")
    ...
    @method("Configuration.GetModificationTime")
    ...
    @method("Configuration.GetLastDeleteTime")
    ...
    @method("Configuration.GetLastClearTime")
    ...
    @method("Configuration.OpenFilter")
    ...
    @method("Configuration.GetNextObjectVID")
    ...
    @method("Configuration.CloseFilter")
    ...
    @method("Configuration.FindLocalObject")
    ...
    @method("Configuration.GetTimeZone")
    ...
    @method("Configuration.GetTimeLocation")
    ...
    @method("Configuration.GetAstronomicalTime")
