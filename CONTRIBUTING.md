...
- Create a new [xsdata-style `@dataclass`](https://xsdata.readthedocs.io/en/latest/models.html) model in `src/aiovantage/models/`
...
- Export the class in `src/aiovantage/models/__init__.py` so it can be automatically parsed
